...
namespace StorageAccount.Repository
{
    ...
    {
        public static string connectionString="DefaultEndpointsProtocol=https;AccountName=renukaiotstorage;AccountKey=i8z+3idrXyQthIdXSGpDudjPF8kTqdGuIPImAPcs7/qIKT305TBmhhqVCrBKoafajZ4bfH3vESlu+AStE4kfZw==;EndpointSuffix=core.windows.net";
        ...
        {
            string path=@"C:\Users\M1080951\Desktop\StorageAccount\Downloads\"+fileName;
            shareServiceClient=new ShareServiceClient(connectionString);
            var serviceClient=shareServiceClient.GetShareClient(fileShareName);
            var dir=serviceClient.GetDirectoryClient(directoryName);
            var file=dir.GetFileClient(fileName);
